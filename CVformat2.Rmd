...
## Description: second blank resume template (format B)
######################################################################################
```
---
title: ''
...
output:
  word_document:
    reference_docx: CV-format2.docx
...
##电话：`r as.name(as.character(phonenumber))` &nbsp; &nbsp; &nbsp; &nbsp; 电子邮箱：`r as.name(as.character(email))`  
...
##Phone number：`r as.name(as.character(phonenumber))` &nbsp; &nbsp; &nbsp; &nbsp;  Email：`r as.name(as.character(email))`  
